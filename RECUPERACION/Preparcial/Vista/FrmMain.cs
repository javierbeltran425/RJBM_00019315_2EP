...
namespace Preparcial.Vista
{
    public partial class FrmMain : Form
    {
        ...
        private void tabControl1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (tabControl1.SelectedTab == tabControl1.TabPages[0]) { } // Agregando validación de hacer click manualmente en la página 0 para que el mensaje 
                                                                             // "No tiene permisos para ver esta pestaña", no se muestre cada vez que se entra en la 
                                                                             // pestaña "General".
